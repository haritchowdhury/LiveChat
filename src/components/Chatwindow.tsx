...
export const ChatWindow: React.FC = () => {
  ...
  if (!currentConversationId) {
    return (
      <div className="flex-1 flex items-center justify-center bg-[#f0f2f5] h-full">
      ...
      <div className="px-4 py-2 bg-[#f0f2f5]">
        <form onSubmit={handleSendMessage} className="flex items-center">
          ...
          <input
            ...
            className="flex-1 py-2 px-4 rounded-lg bg-white border-none focus:outline-none mx-2"
            value={newMessage}
  ...
  if (!currentConversationId) {
    return (
      <div className="flex h-full">
        ...
        <div className="w-8 bg-[#2a2f36] flex flex-col justify-between py-1">
          {/* Top 6 buttons */}
